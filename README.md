...
## Introdução
Esse projeto foi desenvolvido usando a linguagem C#, uma aplicação de console simples, trata-se de um simples jogo de adivinhações, você passa 1 número ao jogo e ele devolve se você acertou ou não, para facilitar, caso você erre o número o programa le informa uma dica se o número sorteado é maior ou menor. Neste jogo, você é limitado a quantidade de vezes para jogar, conforme o nível escolhido.


## Funcionalidades
- **Jogo de Adivinha**: Captura o número digitado, faz comparações entre o digitado e sortado.
- **Tentativas**: É calculado o número de tentativas, conforme o nível.
